...
define( 'EWAY_DEFAULT_GATEWAY_URL', 'https://www.eway.com.au/gateway_cvn/xmlbeagle.asp' );
...
class EwayPayment {
	...
	function getBeagleScore() { 
        return $this->myBeagleScore;
    }
    ...
    function doPayment() {
        ...
        if( curl_errno( $ch ) == CURLE_OK ) {
            ...
            if( xml_get_error_code( $this->parser ) == XML_ERROR_NONE ) {
				...
				$this->myResultBeagleScore = isset($this->xmlData['ewayBeagleScore']) ? $this->xmlData['ewayBeagleScore']:"";
                $this->myError = 0;
                $this->myErrorMessage = '';
            } else {
