...
if(isset($_POST['submit']))
{
	...
	{
      setcookie("admin", $_POST['admin'], time()+3600*8);
      // we don't need this cookie because our new auth.inc script bypasses the database validation
