...
if(sizeof($_POST)>0) {
  ...
  if($_POST['seats']==0) { # this section updates the vouchers to Active if the seats have been changed to 0 so the customer can use the voucher again
  ...
  update_seats_for_schedule($_POST['scheduleid']);//if the seats have been changed above then this code updates any changes for that scheduled class
