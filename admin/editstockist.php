...
if(isset($submit)) {
	...
	$sql="INSERT INTO `stockists` (`stockistname`, `stockistaddress1`, `stockistsuburb`, `stockiststate`, `stockistpostcode`, `stockistphone`, `stockistfax`, `stockistemail`) VALUES ('$stockistname', '$stockistaddress1', '$stockistsuburb', '$stockiststate', '$stockistpostcode', '$stockistphone', '$stockistfax', '$stockistemail');";
	#echo $sql;
	#exit();
