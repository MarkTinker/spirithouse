				...
				<div id='school_classes' class='subsection'>
					<div class='inner'>
						...
						<table class='school'>
						        ...
						        <caption>Best Deals for $testmonth</caption>
						        <thead>
						        <tr class='header'>
    ...
    for($i=0;$i<9999;$i++) {
			...
			<div class='wrap'>				
				...
				<div id='school_classes' class='subsection'>
					<div class='inner'>
						...
						<table class='school'>
						        <caption>Best Deals for $display_month</caption>
						        <thead>
      ...
      if(array_key_exists($search_year,$schedule)) {
        if(array_key_exists($search_month,$schedule[$search_year])) {
            ...
            for($j=0;$j<$classes_for_today;$j++) {
              ...
              if($class=="FINISH") {
                ...
                $seatsleft        =$classseats-$bookings;
                 ...
                 $discounttext= "<span class='teal'>&#36;$discount_total Discount for you</span>";
                 $discountlink="l=1&";
                 }ELSE{
          ...
          } else {// this segment containted the NO CLASS TODAY stuff for blank days BEFORE the first schedule date
        
          }
        
        
        } else {// another NO CLASS TODAY segment
