...
imagettftext($im, 14, 180, 1120, 70, $red,"/home/sh/public_html/arial_italic.ttf",$id." Security Code: ".$securitycode);				
					...
					//echo "../voucherimages/temp".$vouchernum.".jpg";
					...
					//$file="<img src=data:image/jpg;base64,$data>"; 
					//echo $file;
					//exit(); 
...
<p><img alt='Embedded Image' src='data:image/jpg;base64,$data' /></p>
					...
					//$ok = @mail($email_to, $email_subject, $email_message, $headers, $file); 
	...
	$extraheaders = array ('From' => $from, 'To' => $recipient, 'Subject' => $subject);
